...
home.file.".local/share/desktop-directories/ssh-serveryPc.directory".text = ''
[Desktop Entry]
Type=Directory
Name=Servery Pc
Icon=utilities-terminal
...
home.file.".local/share/desktop-directories/ssh-vps.directory".text = ''
[Desktop Entry]
Type=Directory
Name=VPS
Icon=utilities-terminal
...
Type=Application
Name=Nikola
Exec=/home/gregor/.ssh/ssh/ssh-nikola.sh
Icon=utilities-terminal
Terminal=false
StartupNotify=true
'';
...
Exec=/home/gregor/.ssh/ssh/ssh-netcup-lxc-aplikace.sh
Icon=utilities-terminal
Terminal=false
StartupNotify=true
'';
...
Type=Application
Name=Mikrotik Test
Exec=/home/gregor/.ssh/ssh/ssh-mikrotik-test.sh
Icon=utilities-terminal
Terminal=false
StartupNotify=true
'';
