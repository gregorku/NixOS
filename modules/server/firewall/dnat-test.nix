{
  wireguard = {
    wg1 = [
      { port = 5001; target = "10.10.10.10:5001"; }
      { port = 9443; target = "10.10.10.10:8443"; }
      { port = 9442; target = "10.10.10.10:443"; }
      { port = 9444; target = "10.10.10.10:8444"; }
      { port = 9445; target = "10.10.10.10:8445"; }
